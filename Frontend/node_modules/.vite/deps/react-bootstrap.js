...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime84.jsxs)(import_jsx_runtime83.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react48.cloneElement)(children, triggerProps), (0, import_jsx_runtime82.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Spinner = React93.forwardRef(({
  ...
  return (0, import_jsx_runtime92.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames68.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react50.useContext)(TabContext_default);
...
var ToastFade = React102.forwardRef((props, ref) => (0, import_jsx_runtime103.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React104.forwardRef(({
  ...
  const context6 = (0, import_react52.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
